...
//check if "sfmlRenderer" should use "std::cout" or not and if so then add a preprocessor block in "sfmlRenderer.cpp"
...
#define ASSETS_DIR std::string("C:\\Users\\Constantin\\source\\repos\\chessgame\\build\\assets\\")