...
std::vector<chessmen::position> chessmen::possibleMoves(std::vector<chessmen*>* chessmen) {
	std::vector<position> emptyreturn;
	return emptyreturn;
}

chessmen::position_status chessmen::positiocheck(std::vector<chessmen*>* chessmen, position pos, color player) {
...
chessmen::chessmen(color color_input, position position_input) {
